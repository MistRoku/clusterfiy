    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-base-100 rounded-xl shadow-md p-6 border border-base-200/50">
            ...
            <form method="POST" action="{{ route('users.store') }}" class="space-y-4">
                ...
                <div class="form-control">
                    <label class="label"><span class="label-text font-medium">Role <span
                                class="text-error">*</span></span></label>
                ...
                @if (auth()->user()->isSuperAdmin())
                    <div class="form-control">
                        <label class="label"><span class="label-text font-medium">Company <span
                                    class="text-error">*</span></span></label>
                        <select name="company_id" class="select select-bordered @error('company_id') select-error @enderror"
                            required>
                ...
                <div class="alert alert-info">
                    ...
                    <span>A temporary password will be sent to the user's email.</span>
                </div>
